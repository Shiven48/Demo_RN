...
export default function Signup() {
  ...
  const canSubmit = fullName.length > 0 && email.length > 0 && password.length > 6;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      // For demo, always succeed and navigate to OTP
    ...
    >
      <div className="max-w-md mx-auto px-6 pt-12 pb-20">
        ...
        >
          ...
          >
            <span className="text-white font-semibold text-base mr-4">Sign up with Google</span>
          ...
          <div className="flex items-center my-6">
            ...
            <span className="text-gray-500 text-sm mx-4">or register with email</span>
            <div className="flex-1 h-px bg-gray-300" />
          </div>
        </motion.div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            >
              ...
              <div className="pl-4 pr-2">
                <User size={20} color={focusedField === 'fullName' ? '#2DAAAB' : 'gray'} />
              </div>
              <input
                type="text"
                value={fullName}
                ...
                className="w-full px-2 text-base text-gray-900 outline-none bg-transparent"
              />
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="pl-4 pr-2">
                <Mail size={20} color={focusedField === 'email' ? '#2DAAAB' : 'gray'} />
              </div>
              <input
                type="email"
                value={email}
          ...
          >
            ...
            >
              ...
              <div className="pl-4 pr-2">
                <Lock size={20} color={focusedField === 'password' ? '#2DAAAB' : 'gray'} />
              </div>
              <input
                ...
                onBlur={() => setFocusedField(null)}
                placeholder="••••••••"
                className="w-full px-2 text-base text-gray-900 outline-none bg-transparent pr-12"
              />
              <button
                type="button"
            ...
            <p className="text-xs text-gray-400 mt-1 ml-1">Must be at least 7 characters</p>
          </motion.div>
